...
namespace FindMeBand_server.Data.Migrations
{
    ...
    [Migration("20260619143624_AddOpportunityApplicationStatus")]
    partial class AddOpportunityApplicationStatus
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FindMeBand_server.Models.Conversation", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasIndex("Profile1Id", "Profile2Id")
                        .IsUnique();

                    b.ToTable("Conversations");
                });

            modelBuilder.Entity("FindMeBand_server.Models.DirectMessage", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("FindMeBand_server.Models.Notification", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("FindMeBand_server.Models.PostLike", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("FindMeBand_server.Models.Conversation", b =>
                {
                    b.HasOne("FindMeBand_server.Models.Profile", "Profile1")
                        .WithMany()
                        .HasForeignKey("Profile1Id")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();

                    b.HasOne("FindMeBand_server.Models.Profile", "Profile2")
                        .WithMany()
            ...
            modelBuilder.Entity("FindMeBand_server.Models.DirectMessage", b =>
                {
                    b.HasOne("FindMeBand_server.Models.Conversation", "Conversation")
                        .WithMany("Messages")
                        .HasForeignKey("ConversationId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("FindMeBand_server.Models.Profile", "Sender")
                        .WithMany()
            ...
            modelBuilder.Entity("FindMeBand_server.Models.Notification", b =>
                {
                    b.HasOne("FindMeBand_server.Models.Profile", "Actor")
                        .WithMany()
                        .HasForeignKey("ActorProfileId")
                        .OnDelete(DeleteBehavior.NoAction);

                    b.HasOne("FindMeBand_server.Models.Profile", "Recipient")
                        .WithMany()
